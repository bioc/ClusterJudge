consolidate.entity.attribute <-
function(entity.attribute, min.entities.per.attr, mut.inf=NULL,  U.limit = c(0.8, 0.6, 0.4, 0.2, 0.1, 0.01, 0.001)){	
   ...
   if(is.logical(mut.inf) | is.null(mut.inf)){
   	 ...
   	 mut.inf <- attribute.mut.inf(entity.attribute, show.progress=TRUE)
   }	
   ...
   plot(histogram(Uv, type='percent'	           
